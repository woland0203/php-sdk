...
class CardPayRefundsReportTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetConfigSuccessful($mode, $walletId, $restApiLogin, $restApiPassword, $logFilePath)
    {
        ...
        $this->assertInstanceOf(CardPayRefundsReport::class, $cardPayRefundsReport->setConfig($cardPayConfig));
    }
    ...
    public function testSetConfigFailure($mode, $walletId, $restApiLogin, $restApiPassword, $logFilePath)
    {
        ...
        $cardPayRefundsReport = new CardPayRefundsReport();
        $cardPayRefundsReport->setConfig($cardPayConfig);
    }
    ...
    public function testSetNonRequiredFieldsSuccessful(
        ...
        $this->assertInstanceOf(CardPayRefundsReport::class,
            $cardPayRefundsReport->setStartTimestampMilliseconds($startTimestampMilliseconds));
        $this->assertInstanceOf(CardPayRefundsReport::class,
            $cardPayRefundsReport->setEndTimestampMilliseconds($endTimestampMilliseconds));
        $this->assertInstanceOf(CardPayRefundsReport::class,
            $cardPayRefundsReport->setOrderId($orderId));
        $this->assertInstanceOf(CardPayRefundsReport::class,
            $cardPayRefundsReport->setMaxCount($maxCount));
    }
    ...
    public function testGetQueryParamsSuccessful(
        ...
        $this->assertEquals($expected, $cardPayRefundsReport->getQueryParams());
    }
    ...
    public function testGetQueryParamsFailure(
        ...
        $cardPayRefundsReport->getQueryParams();
    }
