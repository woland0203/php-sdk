...
class CardPayPaymentsReport
{
    ...
    /**
     * @var CardPayPaymentsReportCommunicator
     */
    ...
    {
        $this->communicator = new CardPayPaymentsReportCommunicator();
    }
    ...
    public function parseResponse()
    {
        ...
        foreach ($responseJsonObject->data as $transactionData) {
            ...
            $transactionObject->setType(CardPayTypeAttribute::$TYPE_PAYMENTS);
