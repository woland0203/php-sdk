...
2. [Payment page mode](#2-payment-page-mode)
    1. [Simple payment](#2-1-simple-payment)
    2. [Authorized payment](#2-2-authorized-payment)
    3. [Recurring payment](#2-3-recurring-payment)
    4. [Pay with token](#t2-4-pay-with-token)
    5. [Getting orderXML and SHA512](#2-5-getting-orderXML-and-SHA512)
    6. [Adding shipping address](#2-6-adding-shipping-address)
    7. [Adding shopping cart items](#2-7-adding-shopping-cart-items)
3. [Gateway mode](#3-gateway-mode)
    1. [Simple payment](#3-1-simple-payment)
    2. [Authorized payment](#3-2-authorized-payment)
    3. [Recurring payment](#3-3-recurring-payment)
    4. [Pay with token](#3-4-pay-with-token)
    5. [Getting orderXML and SHA512](#3-5-getting-orderxml-and-sha512)
    6. [Adding shipping address](#3-6-adding-shipping-address)
    7. [Adding billing address](#3-7-adding-billing-address)
    8. [Adding shopping cart items](#3-8-adding-shopping-cart-items)
4. [Callback](#4-Callback)
5. [Change order status](#5-change-order-status)
    1. [Capture authorized payment](#5-1-capture-authorized-payment)
    2. [Void authorized payment](#5-2-void-authorized-payment)
    3. [Refund payment](#5-3-refund-payment)
6. [Payment reports](#6-payment-reports)
    1. [Get list of payments](#6-1-get-list-of-payments)
    2. [State of payment](#6-2-state-of-payment)
7. [Refund reports](#7-refund-reports)
    1. [Get the list of refunds](#7-1-get-the-list-of-refunds)
    2. [State of refund](#7-2-state-of-refund)
